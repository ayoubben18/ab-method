...
This workflow will:
1. **Always invoke `grill-with-docs`** to interview the user and pin down the objective, a *verifiable* measurable end state, and constraints (no skip)
...
4. Write `docs/goals/<goal-name>/progress-tracker.md` — a checklist + discoveries log the loop maintains
...
# Grills for objective, measurable end state, and constraints
